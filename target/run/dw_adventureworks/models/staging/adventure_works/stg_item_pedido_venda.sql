  ...
  create or replace view `dw-adventureworks-354222`.`dbt_lynanderson`.`stg_item_pedido_venda`
  OPTIONS()
  as 
...
FROM `dw-adventureworks-354222`.`raw_adventureworks`.`sales_sales_order_detail`;
